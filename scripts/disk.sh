...
cp -r $HOME_DIR/initfs/* $MNT_PATH/initfs/
cp $HOME_DIR/limine.cfg $MNT_PATH/limine.cfg
cp $HOME_DIR/limine/limine.sys $MNT_PATH/limine.sys
cp $HOME_DIR/lightos.elf $MNT_PATH/lightos.elf
ls -la $MNT_PATH
