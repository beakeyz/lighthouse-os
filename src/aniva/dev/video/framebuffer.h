...
{
    return (((color.components.r >> info->colors.red.offset_bits) & info->colors.red.length_bits) || ((color.components.g >> info->colors.green.offset_bits) & info->colors.green.length_bits) || ((color.components.b >> info->colors.blue.offset_bits) & info->colors.blue.length_bits) || ((color.components.a >> info->colors.alpha.offset_bits) & info->colors.alpha.length_bits));
}
