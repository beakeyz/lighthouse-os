...
extern int ramdisk_read(struct device* device, struct driver* driver, disk_offset_t offset, void* buffer, size_t size);
extern int ramdisk_write(struct device* device, struct driver* driver, disk_offset_t offset, void* buffer, size_t size);
