...
typedef EFI_STATUS(EFIAPI* LEGACY_BOOT_CALL)(
...
// == PnP Function 0x61
//
typedef EFI_STATUS(EFIAPI* GET_DEVICE_COUNT)(
...
// == PnP Function 0x62
//
typedef EFI_STATUS(EFIAPI* GET_PRIORITY_AND_TABLE)(
    IN struct _LEGACY_BOOT_INTERFACE* This,
    IN BBS_TYPE* TableType,
...
// == PnP Function 0x63
//
typedef EFI_STATUS(EFIAPI* SET_PRIORITY)(
    IN struct _LEGACY_BOOT_INTERFACE* This,
    IN BBS_TYPE* TableType,
