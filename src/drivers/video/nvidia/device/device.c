...
static int nv_detect_chip(nv_device_t* nvdev)
{
    ...
    if ((pmc_ident & 0x1f000000) > 0) {
        ...
        case 0x010:
            ...
            break;
        case 0x020:
            nvdev->card_type = NV_20;
            break;
        case 0x030:
            nvdev->card_type = NV_30;
            break;
        case 0x040:
        case 0x060:
            nvdev->card_type = NV_40;
            break;
        case 0x050:
        case 0x080:
        case 0x090:
        case 0x0a0:
            nvdev->card_type = NV_50;
            break;
        case 0x0c0:
        case 0x0d0:
            nvdev->card_type = NV_C0;
            break;
        case 0x0e0:
        case 0x0f0:
        case 0x100:
            nvdev->card_type = NV_E0;
            break;
        case 0x110:
        case 0x120:
            nvdev->card_type = GM100;
            break;
        case 0x130:
            nvdev->card_type = GP100;
            break;
        case 0x140:
            nvdev->card_type = GV100;
            break;
        case 0x160:
            nvdev->card_type = TU100;
            break;
        case 0x170:
            nvdev->card_type = GA100;
            break;
        case 0x190:
            nvdev->card_type = AD100;
            break;
        }
    } else {
