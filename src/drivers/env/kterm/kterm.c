...
int kterm_init()
{
    ...
    __kterm_key_watcher_thread = spawn_thread("kterm_key_watcher", SCHED_PRIO_1, kterm_key_watcher, NULL);
    ...
    __kterm_worker_thread = spawn_thread("kterm_cmd_worker", SCHED_PRIO_1, kterm_command_worker, NULL);
