...
class Consts:
    ...
    LIGHTOS_CORE_LIB_NAME = "lightos"
    SYSROOT_DIR = PROJECT_DIR + "/" + SYSROOT_DIR_NAME
    SYSROOT_HEADERS_DIR = SYSROOT_DIR + "/System/Hdrs"
    SYSROOT_LIGHTOS_HEADERS_DIR = SYSROOT_HEADERS_DIR + "/lightos"
    SYSROOT_LIB_DIR = SYSROOT_DIR + "/System/Lib"
